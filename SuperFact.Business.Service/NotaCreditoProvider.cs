...
{
    public class NotaCreditoProvider : INotaCreditoProvider
    {
        ...
        public async Task<EnviarDocumentoResponse> Generar(string organization, DocumentoElectronico model)
        {
            ...
            File.WriteAllBytes("credit-note.xml", Convert.FromBase64String(responseFirma.TramaXmlFirmado));
            ...
            else
            {
                ...
                File.WriteAllBytes("cdr_credit-note.zip", Convert.FromBase64String(response.TramaZipCdr));
