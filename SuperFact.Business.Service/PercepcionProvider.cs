...
{
    public class PercepcionProvider : IPercepcionProvider
    {
        ...
        public async Task<DocumentoPercepcion> Delete(string organization, int id)
        {
        ...
        public async Task<DocumentoPercepcion> Get(string organization, int id)
        {
            throw new NotImplementedException();
        }

        public async Task<IEnumerable<DocumentoPercepcion>> GetAll(string organization)
        {
            throw new NotImplementedException();
        }
